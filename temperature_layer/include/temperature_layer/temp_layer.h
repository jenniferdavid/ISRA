...
#include <temperature_layer/TemperatureLayerConfig.h>
...
private:
  ...
  void reconfigureCB(temperature_layer::TemperatureLayerConfig &config, uint32_t level);
  dynamic_reconfigure::Server<temperature_layer::TemperatureLayerConfig> *dsrv_;
