...
struct DashboardState_
{
  ...
  _motors_halted_valid_type motors_halted_valid;
   ...
   typedef  ::cob_msgs::PowerBoardState_<ContainerAllocator>  _power_board_state_type;
  ...
  _power_state_valid_type power_state_valid;
   ...
   typedef  ::cob_msgs::AccessPoint_<ContainerAllocator>  _access_point_type;
...
struct Printer< ::cob_msgs::DashboardState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::cob_msgs::DashboardState_<ContainerAllocator>& v)
  {
    ...
    s << std::endl;
    Printer< ::cob_msgs::PowerBoardState_<ContainerAllocator> >::stream(s, indent + "  ", v.power_board_state);
    ...
    s << std::endl;
    Printer< ::cob_msgs::AccessPoint_<ContainerAllocator> >::stream(s, indent + "  ", v.access_point);
