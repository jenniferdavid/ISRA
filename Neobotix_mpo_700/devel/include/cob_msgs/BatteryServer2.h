// Generated by gencpp from file cob_msgs/BatteryServer2.msg
// DO NOT EDIT!


#ifndef COB_MSGS_MESSAGE_BATTERYSERVER2_H
#define COB_MSGS_MESSAGE_BATTERYSERVER2_H
...
struct BatteryServer2_
{
  ...
  _last_controller_update_type last_controller_update;
   ...
   typedef std::vector< ::cob_msgs::BatteryState2_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::cob_msgs::BatteryState2_<ContainerAllocator> >::other >  _battery_type;
  ...
  typedef boost::shared_ptr< ::cob_msgs::BatteryServer2_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::cob_msgs::BatteryServer2_<ContainerAllocator> const> ConstPtr;

}; // struct BatteryServer2_

typedef ::cob_msgs::BatteryServer2_<std::allocator<void> > BatteryServer2;

typedef boost::shared_ptr< ::cob_msgs::BatteryServer2 > BatteryServer2Ptr;
typedef boost::shared_ptr< ::cob_msgs::BatteryServer2 const> BatteryServer2ConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::cob_msgs::BatteryServer2_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::cob_msgs::BatteryServer2_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::cob_msgs::BatteryServer2_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::cob_msgs::BatteryServer2_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::cob_msgs::BatteryServer2_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::cob_msgs::BatteryServer2_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::cob_msgs::BatteryServer2_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::cob_msgs::BatteryServer2_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::cob_msgs::BatteryServer2_<ContainerAllocator> >
{
  ...
  static const char* value(const ::cob_msgs::BatteryServer2_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x5f2cec7d06c312d7ULL;
  static const uint64_t static_value2 = 0x56189db96c1f3819ULL;
};

template<class ContainerAllocator>
struct DataType< ::cob_msgs::BatteryServer2_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::cob_msgs::BatteryServer2_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::cob_msgs::BatteryServer2_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::cob_msgs::BatteryServer2_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::cob_msgs::BatteryServer2_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    for (size_t i = 0; i < v.battery.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::cob_msgs::BatteryState2_<ContainerAllocator> >::stream(s, indent + "    ", v.battery[i]);
    }
  }
};
...
#endif // COB_MSGS_MESSAGE_BATTERYSERVER2_H
