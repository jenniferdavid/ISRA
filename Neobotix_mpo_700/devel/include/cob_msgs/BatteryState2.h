// Generated by gencpp from file cob_msgs/BatteryState2.msg
// DO NOT EDIT!


#ifndef COB_MSGS_MESSAGE_BATTERYSTATE2_H
#define COB_MSGS_MESSAGE_BATTERYSTATE2_H
...
struct BatteryState2_
{
  ...
  typedef boost::shared_ptr< ::cob_msgs::BatteryState2_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::cob_msgs::BatteryState2_<ContainerAllocator> const> ConstPtr;

}; // struct BatteryState2_

typedef ::cob_msgs::BatteryState2_<std::allocator<void> > BatteryState2;

typedef boost::shared_ptr< ::cob_msgs::BatteryState2 > BatteryState2Ptr;
typedef boost::shared_ptr< ::cob_msgs::BatteryState2 const> BatteryState2ConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::cob_msgs::BatteryState2_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::cob_msgs::BatteryState2_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::cob_msgs::BatteryState2_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::cob_msgs::BatteryState2_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::cob_msgs::BatteryState2_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::cob_msgs::BatteryState2_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::cob_msgs::BatteryState2_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::cob_msgs::BatteryState2_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::cob_msgs::BatteryState2_<ContainerAllocator> >
{
  ...
  static const char* value(const ::cob_msgs::BatteryState2_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x91b4acb000aa990aULL;
  static const uint64_t static_value2 = 0xc3006834f9a99669ULL;
};

template<class ContainerAllocator>
struct DataType< ::cob_msgs::BatteryState2_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::cob_msgs::BatteryState2_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::cob_msgs::BatteryState2_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::cob_msgs::BatteryState2_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::cob_msgs::BatteryState2_<ContainerAllocator>& v)
  {
    s << indent << "present: ";
...
#endif // COB_MSGS_MESSAGE_BATTERYSTATE2_H
