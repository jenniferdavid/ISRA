// Generated by gencpp from file cob_msgs/PowerBoardState.msg
// DO NOT EDIT!


#ifndef COB_MSGS_MESSAGE_POWERBOARDSTATE_H
#define COB_MSGS_MESSAGE_POWERBOARDSTATE_H
...
struct PowerBoardState_
{
  ...
  typedef boost::shared_ptr< ::cob_msgs::PowerBoardState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::cob_msgs::PowerBoardState_<ContainerAllocator> const> ConstPtr;

}; // struct PowerBoardState_

typedef ::cob_msgs::PowerBoardState_<std::allocator<void> > PowerBoardState;

typedef boost::shared_ptr< ::cob_msgs::PowerBoardState > PowerBoardStatePtr;
typedef boost::shared_ptr< ::cob_msgs::PowerBoardState const> PowerBoardStateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::cob_msgs::PowerBoardState_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::cob_msgs::PowerBoardState_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::cob_msgs::PowerBoardState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::cob_msgs::PowerBoardState_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::cob_msgs::PowerBoardState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::cob_msgs::PowerBoardState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::cob_msgs::PowerBoardState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::cob_msgs::PowerBoardState_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::cob_msgs::PowerBoardState_<ContainerAllocator> >
{
  ...
  static const char* value(const ::cob_msgs::PowerBoardState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x08899b671e6a1a44ULL;
  static const uint64_t static_value2 = 0x9e7ce0000da8ae7bULL;
};

template<class ContainerAllocator>
struct DataType< ::cob_msgs::PowerBoardState_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::cob_msgs::PowerBoardState_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::cob_msgs::PowerBoardState_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::cob_msgs::PowerBoardState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::cob_msgs::PowerBoardState_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // COB_MSGS_MESSAGE_POWERBOARDSTATE_H
