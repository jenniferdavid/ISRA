// Generated by gencpp from file cob_msgs/BatteryServer.msg
// DO NOT EDIT!


#ifndef COB_MSGS_MESSAGE_BATTERYSERVER_H
#define COB_MSGS_MESSAGE_BATTERYSERVER_H
...
struct BatteryServer_
{
  ...
  _inhibited_type inhibited;
   ...
   typedef std::vector< ::cob_msgs::BatteryState_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::cob_msgs::BatteryState_<ContainerAllocator> >::other >  _battery_type;
  ...
  typedef boost::shared_ptr< ::cob_msgs::BatteryServer_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::cob_msgs::BatteryServer_<ContainerAllocator> const> ConstPtr;

}; // struct BatteryServer_

typedef ::cob_msgs::BatteryServer_<std::allocator<void> > BatteryServer;

typedef boost::shared_ptr< ::cob_msgs::BatteryServer > BatteryServerPtr;
typedef boost::shared_ptr< ::cob_msgs::BatteryServer const> BatteryServerConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::cob_msgs::BatteryServer_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::cob_msgs::BatteryServer_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::cob_msgs::BatteryServer_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::cob_msgs::BatteryServer_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::cob_msgs::BatteryServer_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::cob_msgs::BatteryServer_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::cob_msgs::BatteryServer_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::cob_msgs::BatteryServer_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::cob_msgs::BatteryServer_<ContainerAllocator> >
{
  ...
  static const char* value(const ::cob_msgs::BatteryServer_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x4f6d6e54c9581bebULL;
  static const uint64_t static_value2 = 0x1df7ea408c0727beULL;
};

template<class ContainerAllocator>
struct DataType< ::cob_msgs::BatteryServer_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::cob_msgs::BatteryServer_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# DEPRECATED. Use cob_msgs/BatteryServer2 instead.\n"
"Header header\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::cob_msgs::BatteryServer_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::cob_msgs::BatteryServer_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::cob_msgs::BatteryServer_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    for (size_t i = 0; i < v.battery.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::cob_msgs::BatteryState_<ContainerAllocator> >::stream(s, indent + "    ", v.battery[i]);
    }
  }
};
...
#endif // COB_MSGS_MESSAGE_BATTERYSERVER_H
