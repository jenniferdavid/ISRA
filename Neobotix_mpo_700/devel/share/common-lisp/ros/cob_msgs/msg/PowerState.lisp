...
(cl:defmethod prediction_method-val ((m <PowerState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_msgs-msg:prediction_method-val is deprecated.  Use cob_msgs-msg:prediction_method instead.")
  (prediction_method m))

(cl:ensure-generic-function 'relative_capacity-val :lambda-list '(m))
(cl:defmethod relative_capacity-val ((m <PowerState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_msgs-msg:relative_capacity-val is deprecated.  Use cob_msgs-msg:relative_capacity instead.")
  (relative_capacity m))

(cl:ensure-generic-function 'AC_present-val :lambda-list '(m))
(cl:defmethod AC_present-val ((m <PowerState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_msgs-msg:AC_present-val is deprecated.  Use cob_msgs-msg:AC_present instead.")
  (AC_present m))
