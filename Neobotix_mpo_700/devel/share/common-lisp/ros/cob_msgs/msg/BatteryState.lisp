...
(cl:defmethod cl:initialize-instance :after ((m <BatteryState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BatteryState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cob_msgs-msg:<BatteryState> is deprecated: use cob_msgs-msg:BatteryState instead.")))

(cl:ensure-generic-function 'lastTimeBattery-val :lambda-list '(m))
(cl:defmethod lastTimeBattery-val ((m <BatteryState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_msgs-msg:lastTimeBattery-val is deprecated.  Use cob_msgs-msg:lastTimeBattery instead.")
  (lastTimeBattery m))

(cl:ensure-generic-function 'batReg-val :lambda-list '(m))
(cl:defmethod batReg-val ((m <BatteryState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_msgs-msg:batReg-val is deprecated.  Use cob_msgs-msg:batReg instead.")
  (batReg m))

(cl:ensure-generic-function 'batRegFlag-val :lambda-list '(m))
(cl:defmethod batRegFlag-val ((m <BatteryState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_msgs-msg:batRegFlag-val is deprecated.  Use cob_msgs-msg:batRegFlag instead.")
  (batRegFlag m))

(cl:ensure-generic-function 'batRegTime-val :lambda-list '(m))
(cl:defmethod batRegTime-val ((m <BatteryState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_msgs-msg:batRegTime-val is deprecated.  Use cob_msgs-msg:batRegTime instead.")
  (batRegTime m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<BatteryState>)))
  ...
  (cl:format cl:nil "# DEPRECATED.  Use cob_msgs/BatteryState2 instead.~%# Each batteries registers~%int32 lastTimeBattery #epoch time~%uint16[48] batReg~%uint16[48] batRegFlag~%int32[48] batRegTime~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'BatteryState)))
  "Returns full string definition for message of type 'BatteryState"
  (cl:format cl:nil "# DEPRECATED.  Use cob_msgs/BatteryState2 instead.~%# Each batteries registers~%int32 lastTimeBattery #epoch time~%uint16[48] batReg~%uint16[48] batRegFlag~%int32[48] batRegTime~%~%~%"))
