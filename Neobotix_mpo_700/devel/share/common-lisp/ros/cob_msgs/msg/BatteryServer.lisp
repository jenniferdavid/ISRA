...
(cl:defclass <BatteryServer> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (battery
    :reader battery
    :initarg :battery
    :type (cl:vector cob_msgs-msg:BatteryState)
   :initform (cl:make-array 0 :element-type 'cob_msgs-msg:BatteryState :initial-element (cl:make-instance 'cob_msgs-msg:BatteryState))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <BatteryServer>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BatteryServer)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cob_msgs-msg:<BatteryServer> is deprecated: use cob_msgs-msg:BatteryServer instead.")))
...
(cl:defmethod lastTimeSystem-val ((m <BatteryServer>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_msgs-msg:lastTimeSystem-val is deprecated.  Use cob_msgs-msg:lastTimeSystem instead.")
  (lastTimeSystem m))

(cl:ensure-generic-function 'timeLeft-val :lambda-list '(m))
(cl:defmethod timeLeft-val ((m <BatteryServer>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_msgs-msg:timeLeft-val is deprecated.  Use cob_msgs-msg:timeLeft instead.")
  (timeLeft m))

(cl:ensure-generic-function 'averageCharge-val :lambda-list '(m))
(cl:defmethod averageCharge-val ((m <BatteryServer>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_msgs-msg:averageCharge-val is deprecated.  Use cob_msgs-msg:averageCharge instead.")
  (averageCharge m))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <BatteryServer>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_msgs-msg:message-val is deprecated.  Use cob_msgs-msg:message instead.")
  (message m))

(cl:ensure-generic-function 'lastTimeController-val :lambda-list '(m))
(cl:defmethod lastTimeController-val ((m <BatteryServer>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_msgs-msg:lastTimeController-val is deprecated.  Use cob_msgs-msg:lastTimeController instead.")
  (lastTimeController m))

(cl:ensure-generic-function 'present-val :lambda-list '(m))
(cl:defmethod present-val ((m <BatteryServer>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_msgs-msg:present-val is deprecated.  Use cob_msgs-msg:present instead.")
  (present m))
...
(cl:defmethod discharging-val ((m <BatteryServer>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_msgs-msg:discharging-val is deprecated.  Use cob_msgs-msg:discharging instead.")
  (discharging m))

(cl:ensure-generic-function 'reserved-val :lambda-list '(m))
(cl:defmethod reserved-val ((m <BatteryServer>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_msgs-msg:reserved-val is deprecated.  Use cob_msgs-msg:reserved instead.")
  (reserved m))

(cl:ensure-generic-function 'powerPresent-val :lambda-list '(m))
(cl:defmethod powerPresent-val ((m <BatteryServer>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_msgs-msg:powerPresent-val is deprecated.  Use cob_msgs-msg:powerPresent instead.")
  (powerPresent m))

(cl:ensure-generic-function 'powerNG-val :lambda-list '(m))
(cl:defmethod powerNG-val ((m <BatteryServer>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_msgs-msg:powerNG-val is deprecated.  Use cob_msgs-msg:powerNG instead.")
  (powerNG m))

(cl:ensure-generic-function 'inhibited-val :lambda-list '(m))
(cl:defmethod inhibited-val ((m <BatteryServer>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_msgs-msg:inhibited-val is deprecated.  Use cob_msgs-msg:inhibited instead.")
  (inhibited m))

(cl:ensure-generic-function 'battery-val :lambda-list '(m))
(cl:defmethod battery-val ((m <BatteryServer>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_msgs-msg:battery-val is deprecated.  Use cob_msgs-msg:battery instead.")
  (battery m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <BatteryServer>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'battery)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'cob_msgs-msg:BatteryState))
