...
(cl:defclass <BatteryServer2> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (battery
    :reader battery
    :initarg :battery
    :type (cl:vector cob_msgs-msg:BatteryState2)
   :initform (cl:make-array 0 :element-type 'cob_msgs-msg:BatteryState2 :initial-element (cl:make-instance 'cob_msgs-msg:BatteryState2))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <BatteryServer2>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BatteryServer2)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cob_msgs-msg:<BatteryServer2> is deprecated: use cob_msgs-msg:BatteryServer2 instead.")))
...
(cl:defmethod last_system_update-val ((m <BatteryServer2>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_msgs-msg:last_system_update-val is deprecated.  Use cob_msgs-msg:last_system_update instead.")
  (last_system_update m))

(cl:ensure-generic-function 'time_left-val :lambda-list '(m))
(cl:defmethod time_left-val ((m <BatteryServer2>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_msgs-msg:time_left-val is deprecated.  Use cob_msgs-msg:time_left instead.")
  (time_left m))

(cl:ensure-generic-function 'average_charge-val :lambda-list '(m))
(cl:defmethod average_charge-val ((m <BatteryServer2>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_msgs-msg:average_charge-val is deprecated.  Use cob_msgs-msg:average_charge instead.")
  (average_charge m))
...
(cl:defmethod last_controller_update-val ((m <BatteryServer2>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cob_msgs-msg:last_controller_update-val is deprecated.  Use cob_msgs-msg:last_controller_update instead.")
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <BatteryServer2>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'battery)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'cob_msgs-msg:BatteryState2))
