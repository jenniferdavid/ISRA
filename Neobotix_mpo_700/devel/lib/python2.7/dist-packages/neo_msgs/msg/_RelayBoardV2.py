...
class RelayBoardV2(genpy.Message):
  _md5sum = "ccce5e129c9e20212af590d84bbc6931"
...
"""
  ...
  __slots__ = ['relayboardv2_state','communication_state','charging_state','temperature','battery_voltage','charging_current','relay_states','keypad','shutdown']
  _slot_types = ['bool[16]','int16','int16','int16','float32','float32','bool[4]','bool[8]','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       relayboardv2_state,communication_state,charging_state,temperature,battery_voltage,charging_current,relay_states,keypad,shutdown
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_B().pack(self.shutdown))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.relayboardv2_state = map(bool, self.relayboardv2_state)
      _x = self
      start = end
      end += 14
      ...
      self.relay_states = map(bool, self.relay_states)
      start = end
      end += 8
      self.keypad = _get_struct_8B().unpack(str[start:end])
      self.keypad = map(bool, self.keypad)
      start = end
      end += 1
