...
"""autogenerated by genpy from cob_msgs/BatteryServer.msg. Do not edit."""
import sys
...
class BatteryServer(genpy.Message):
  ...
  _type = "cob_msgs/BatteryServer"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """# DEPRECATED. Use cob_msgs/BatteryServer2 instead.
Header header
...
"""
  ...
  _slot_types = ['std_msgs/Header','int32','int32','uint16','uint16','string','int32','uint16','uint16','uint16','uint16','uint16','uint16','uint16','cob_msgs/BatteryState[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = cob_msgs.msg.BatteryState()
        start = end
        end += 4
